...
RSpec.describe 'Matrix#map!' do
  ...
  it 'throws an error when matrix is frozen' do
    x = Matrix[[0, 0]].freeze
    expect { x.map! { |e| 2 * e } }.to raise_error(FrozenError, "can't modify frozen Matrix")
  end
end
